...
CREATE TABLE public.TB_MEMBERSHIP_HISTORY (
    MEMBERSHIP_HISTORY_ID serial NOT NULL, -- System-generated ID for a Group.
	MEMBERSHIP_ID integer NOT NULL,
    PERSON_ID integer NOT NULL,
    GROUP_ID integer NOT NULL,
    MEMBERSHIP_FROM_TS timestamp without time zone NOT NULL,
	MEMBERSHIP_TO_TS timestamp without time zone,
    CONSTRAINT PKTB_MEMBERSHIP_HISTORY PRIMARY KEY (MEMBERSHIP_HISTORY_ID)
);
...
CREATE TABLE public.TB_GROUP_MANAGER_HISTORY (
    MANAGER_HISTORY_ID serial NOT NULL, -- System-generated ID for a Group.
	MANAGER_ID integer NOT NULL,
    GROUP_ID integer NOT NULL,
    PERSON_ID integer NOT NULL,
    MANAGER_FROM_TS timestamp without time zone NOT NULL,
	MANAGER_TO_TS timestamp without time zone,
	CONSTRAINT PKTB_GROUP_MANAGER_HISTORY PRIMARY KEY (MANAGER_HISTORY_ID)
);
